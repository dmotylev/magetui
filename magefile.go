...
// This repo dogfoods itself: targets render through magetui. Public
// targets wrap their body in magetui.Target; the bare
...
// The comprehensive demo rig is examples/ (`mage -d examples everything`).
